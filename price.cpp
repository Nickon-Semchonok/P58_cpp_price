...
/*
git - VCS (Version Control System)система, 
що дозволяє "зберігати" версії коду 
з можливістю повернення до попередніх версій, 
а такожутворення відгалужень (гілок)з різним розвиткомпроєкту.
Суть збереження "різниці" - відмінності між попереднім
і поточним станом проєкту - коміти (commits)
Це також спрощує сумісну роботу з проєктом різних учасниками.

Githud - hub (мысце для розмыщення) ропозиторыъв проектыв.
Репозиторыъ - частина проэкту, до якоъ входить код,
напрацьований розробниками, ы не входять загальны ресурси,
якы можна довантажити окремо (загальні бібліотери тощо),
а також результати компіляції та збірки (проміжки та виконавчі
файли)
Відмінність здається спец файл
*/